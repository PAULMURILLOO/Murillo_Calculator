package com.example.murillo_calculator_final;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num1 = (EditText) findViewById(R.id.TxTName1);
        num2 = (EditText) findViewById(R.id.TXTName2);
        addition = (Button) findViewById(R.id.AdditionButton);
        subtraction = (Button) findViewById(R.id.SubButton2);
